---
{"dg-publish":true,"permalink":"/USMLE/Neurology/Multiple sclerosis/"}
---
...
- Environmental risk factors
	- Low [[USMLE/Biochemistry/Vitamin D\|vitamin D]] levels (insufficient intake, decreased exposure to UV radiation)

---
# Pathophysiology
![L39372.jpg](/img/user/appendix/L39372.jpg)
...
- B-[[USMLE/Blood/Lymphocyte\|lymphocyte]] dysfunction: The following suggests that B-lymphocytes play a role in the pathogenesis of MS, although the exact mechanism of their involvement is unclear.
...
---
# Clinical features
![Pasted image 20230923161821.png](/img/user/appendix/Pasted%20image%2020230923161821.png)
...
- <span style="background:rgba(240, 200, 0, 0.2)">[[USMLE/Neurology/Internuclear ophthalmoplegia\|Internuclear ophthalmoplegia]] (INO) as a result of a lesion in the medial longitudinal fasciculus (MLF) </span>
...
- Demyelination of spinal cord tracts
	...
	- <span style="background:rgba(240, 200, 0, 0.2)">Pyramidal tract lesion: upper motor neuron weakness, spasticity, hyperreflexia, positive Babinski sign, impaired [[USMLE/Neurology/Gait\|gait]]</span>
	- <span style="background:rgba(240, 200, 0, 0.2)">Dorsal spinal column lesion</span>: loss of vibration and fine-touch sensation, numbness, paresthesias, [[USMLE/Neurology/Gait\|sensory ataxia]] usually involving the trunk or one or more limbs 
	- Neuropathic pain
	- Absent abdominal reflex
- Cerebellar involvement: poor postural control, imbalance, [[USMLE/Neurology/Gait\|gait]] dysfunction, Charcot neurological triad of scanning speech, nystagmus, and intention tremors 
- Transverse myelitis
...
- Autonomic dysfunction: bowel and <span style="background:rgba(240, 200, 0, 0.2)">bladder neurogenic disorders</span> (e.g., [[USMLE/Renal/Urinary incontinence\|urinary incontinence]]), impaired sexual function 
...
## Imaging
- MRI:<span style="background:rgba(240, 200, 0, 0.2)"> Multiple sclerotic plaques (most commonly found in the periventricular white matter)</span> with finger-like radial extensions (Dawson fingers) related to demyelination and reactive gliosis![Pasted image 20231231095808.png](/img/user/appendix/Pasted%20image%2020231231095808.png)![Pasted image 20231231095812.png](/img/user/appendix/Pasted%20image%2020231231095812.png)There are extensive demyelinating lesions (plaques) bilaterally, appearing as hyperintensities in the periventricular white matter (green overlay). The finger-like radial extensions of these lesions are called “Dawson fingers.”
## Additional studies
- CSF examination
	- <span style="background:rgba(240, 200, 0, 0.2)">Oligoclonal bands</span>
		- Oligoclonal bands manifest <span style="background:rgba(240, 200, 0, 0.2)">due to increased production of multiple nonspecific IgG sub-fractions in the CSF, which are caused by intrathecal inflammation.</span>![L39066.jpg](/img/user/appendix/L39066.jpg)
